...
const routes: RouteRecordRaw[] = [
  ...
  { path: "/market", name: "market", component: () => import("@/views/MarketHubView.vue"), meta: { title: "行情与事件" } },
  { path: "/trade", name: "trade", component: () => import("@/views/TradeView.vue"), props: () => ({ mode: useApp().mode }), meta: { title: "交易" } },
  { path: "/trade/paper", redirect: () => { useApp().setMode("paper"); return "/trade"; } },
  { path: "/trade/live", redirect: () => { useApp().setMode("live"); return "/trade"; } },
