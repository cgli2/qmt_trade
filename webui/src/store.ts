...
export const useApp = defineStore("app", () => {
  ...
  const savedMode = localStorage.getItem("qmt_mode_v2");
  const mode = ref<"paper" | "live">(savedMode === "live" ? "live" : "paper");
  if (savedMode && !["paper", "live"].includes(savedMode)) localStorage.setItem("qmt_mode_v2", "paper");
